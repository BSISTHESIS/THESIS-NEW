...
//            Toast.makeText(this,value_quantity+cartTotal.text.toString(),Toast.LENGTH_LONG).show()
            if(cartTotal.text.toString().equals("0")){
                Toast.makeText(this@OrderItem,"PLEASE INDICATE THE QUANTITY FIRST",Toast.LENGTH_LONG).show()
            }else{
                val intent = getIntent();
                val myValue = intent.getStringExtra("product_image")
                val myProduct = intent.getStringExtra("product_name")
                ...
                SweetAlertDialog(this@OrderItem, SweetAlertDialog.WARNING_TYPE)
                    .setTitleText("CONTINUE  THIS ADD CART THIS ITEM?")
                    .setConfirmText("CONFIRM!")
                    .setConfirmClickListener { sDialog ->
                       var price_s = text_price.text.toString()
                        var quantity_s = cartTotal.text.toString()
                        ...
                        val add_cart = CustomerDataOrder(
                            ...
                            final_total.toDouble().toString(),product_code.toString()
                        )
                        ...
                        Toast.makeText(this@OrderItem,"ORDER ADDED TO CART",Toast.LENGTH_LONG).show()
