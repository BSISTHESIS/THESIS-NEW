...
import com.jcreates.houseofcoffee.DialogFragment.InsertNewImagesDrinks

import com.jcreates.coffeev3.adapter.TaskAdapterShowDrinks
import com.joey.noteapplication.data.viewModel.DrinksViewModel

class AdminDrinks : AppCompatActivity() {
    lateinit var btn_add : FloatingActionButton
    private var taskRecyclerView: RecyclerView? = null
    private var taskAdapter: TaskAdapterShowDrinks? = null
    ...
    fun UiElement(){
        ...
        taskAdapter = TaskAdapterShowDrinks(this@AdminDrinks,this@AdminDrinks)
    ...
    private fun loadDataTask() {
        ...
        drinksViewModel?.allnotes?.observe(this, Observer { user->
...
//        backPressedTime = System.currentTimeMillis()
    ...
    fun Functions(){
        btn_add.setOnClickListener {
            val args = Bundle()
            val userPopUp = InsertNewImagesDrinks()
