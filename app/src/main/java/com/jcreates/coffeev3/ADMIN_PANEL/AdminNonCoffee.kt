...
import com.jcreates.coffeev3.adapter.TaskAdapterShowNonCoffee
import com.jcreates.houseofcoffee.DialogFragment.InsertNewImagesNonCoffee
import com.joey.noteapplication.data.viewModel.NonCoffeeViewModel

class AdminNonCoffee : AppCompatActivity() {
    lateinit var btn_add : FloatingActionButton
    private var taskRecyclerView: RecyclerView? = null
    private var taskAdapter: TaskAdapterShowNonCoffee? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_non_coffee)
        UiElement()
        Functions()
    }
    ...
    fun UiElement(){
        ...
        taskAdapter = TaskAdapterShowNonCoffee(this@AdminNonCoffee,this@AdminNonCoffee)
    ...
    private fun loadDataTask() {
        ...
        nonCoffeeViewModel?.allnotes?.observe(this, Observer { user->
...
//        backPressedTime = System.currentTimeMillis()
    ...
    fun Functions(){
        btn_add.setOnClickListener {
            val args = Bundle()
            val userPopUp = InsertNewImagesNonCoffee()
