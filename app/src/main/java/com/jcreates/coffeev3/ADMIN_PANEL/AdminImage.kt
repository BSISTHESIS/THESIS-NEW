...
import com.jcreates.coffeev3.adapter.TaskAdapterShowImage
import com.jcreates.houseofcoffee.DialogFragment.InsertNewImageSlide
import com.joey.noteapplication.data.viewModel.ImageViewModel

class AdminImage : AppCompatActivity() {
    lateinit var btn_add : FloatingActionButton
    private var taskRecyclerView: RecyclerView? = null
    private var taskAdapter: TaskAdapterShowImage? = null
    private var imageSlideViewModel: ImageViewModel? = null
    ...
    fun UiElement(){
        ...
        taskAdapter = TaskAdapterShowImage(this@AdminImage,this@AdminImage)
    ...
    private fun loadDataTask() {
        imageSlideViewModel = ViewModelProvider(this).get(ImageViewModel::class.java)

        imageSlideViewModel?.allnotes2?.observe(this, Observer { user->
...
//        backPressedTime = System.currentTimeMillis()
    ...
    fun Functions(){
        btn_add.setOnClickListener {
            val args = Bundle()
            val userPopUp = InsertNewImageSlide()
