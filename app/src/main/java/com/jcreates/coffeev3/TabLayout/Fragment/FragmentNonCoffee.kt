...
import com.jcreates.coffeev3.adapter.TaskAdapterShowOrderNonCoffee
...
class FragmentNonCoffee : Fragment() {
    // TODO: Rename and change types of parameters
    private var taskRecyclerView: RecyclerView? = null
    private lateinit var nonCoffeeViewModel: NonCoffeeViewModel
    private  var taskAdapter: TaskAdapterShowOrderNonCoffee? = null
    ...
    override fun onCreateView(
        ...
        // Inflate the layout for this fragment
        val view: View = inflater.inflate(R.layout.fragment_noncoffee, container, false)
        uiComponent(view)
        functions()
        return view
    }
    ...
    fun uiComponent(view:View){
        ...
        taskAdapter = TaskAdapterShowOrderNonCoffee(requireActivity().applicationContext,requireActivity())
        taskRecyclerView?.setAdapter(taskAdapter)

        nonCoffeeViewModel = ViewModelProvider(this).get(NonCoffeeViewModel::class.java)

        nonCoffeeViewModel?.allnotes2?.observe(viewLifecycleOwner, Observer { user->
